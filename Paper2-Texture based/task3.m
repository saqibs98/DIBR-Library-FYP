...
filenamea  = "Newspaper_depthfilling_4_1024x768.yuv";
...
% holes filling
        %  [cmin,cmax,YMD]=filling_Disocclusion_Depth_Map(YMD,holesV);
        %  yuv_export(YM',UM',VM',filenamea,1);
        [y]=kMeansCluster(YMD,2);
end          
