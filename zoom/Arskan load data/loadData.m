...
elseif expNo == 4
    %Kendo
    totalFrames = 300;    
    camFileNameLeft = "E:\University_data\MSCS\3rdSemester\research\data\3DV\kendo\kendo_c_1_1024x768.yuv";
    camFileNameRight = "E:\University_data\MSCS\3rdSemester\research\data\3DV\kendo\kendo_c_5_1024x768.yuv";    
    depFileNameLeft = "E:\University_data\MSCS\3rdSemester\research\data\3DV\kendo\kendo_d_1_1024x768.yuv";
    depFileNameRight = "E:\University_data\MSCS\3rdSemester\research\data\3DV\kendo\kendo_d_5_1024x768.yuv";
...
%     depFileNameRight = strcat('Poznan_Street_d_3_1920x1088_QP', dQP, '_sim.yuv');
    ...
    camFileNameLeft = strcat('C:\3DV\SEQUENCES\Poznan_Street\Poznan_Street_00_1920x1088_rec_cam05.yuv');
    camFileNameRight = strcat('C:\3DV\SEQUENCES\Poznan_Street\Poznan_Street_00_1920x1088_rec_cam03.yuv');
    depFileNameLeft = strcat('C:\3DV\SEQUENCES\Poznan_Street\Poznan_Street_00_1920x1088_depth_cam05.yuv');
    depFileNameRight = strcat('C:\3DV\SEQUENCES\Poznan_Street\Poznan_Street_00_1920x1088_depth_cam03.yuv');
     virtual_View_Sequence_Name = "Poznan_Street_v_2_1920x1088.yuv";
...
elseif expNo == 8
    ...
    camFileNameLeft = 'D:\UNIVERSITY DATA\fyp\Newspaper\Newspaper_c_2_1024x768.yuv';
    camFileNameRight = 'D:\UNIVERSITY DATA\fyp\Newspaper\Newspaper_c_6_1024x768.yuv';
    
    depFileNameLeft = 'D:\UNIVERSITY DATA\fyp\Newspaper\Newspaper_d_2_1024x768.yuv';
    depFileNameRight = 'D:\UNIVERSITY DATA\fyp\Newspaper\Newspaper_d_6_1024x768.yuv';
