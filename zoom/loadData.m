function [virtualView3, originalView3,width, height,totalFrames] = loadData(expNo, tQP, dQP)
...
elseif expNo == 8
    ...
    virtual_View_Sequence_Name = "D:\BS-IT\Sem 7\FYP- Library\Sir data\3DV Data\New Data\Newspaper\Newspaper_v_4_1024x768.yuv";
